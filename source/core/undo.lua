...
local function copySnapshot(snap)
    ...
    -- Einmal-Mechanik: Verbrauchsmengen sind Teil des Zustands (Undo stellt
    -- damit den „unbenutzt“-Zustand eines Einmalschalters/der Einmal-Brücke
    -- wieder her). Defensiv gegen ältere Snapshots ohne diese Felder.
    copy.consumedSwitches = {}
    for id in pairs(snap.consumedSwitches or {}) do copy.consumedSwitches[id] = true end
    copy.consumedBridges = {}
    for id in pairs(snap.consumedBridges or {}) do copy.consumedBridges[id] = true end
    copy.player = {
